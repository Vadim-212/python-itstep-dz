...
riddles = [
    ...
    riddle(4,'Каких камней в море нет?','Сухих','Круглых,Квадратных,Треугольных'),
    riddle(5,'Висит на стене и в то же время падает. Что это?','Барометр','Стрелка часов,Вешалка,Шторы')
]
